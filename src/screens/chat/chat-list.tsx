...
import ChatList from '../../../src/components/organisms/chat/list';
import { outline, text, button } from '../../styles/color';
import NewDeleteIcon from '../../../src/components/atoms/icon/new-delete';
...
import GroupImage from '../../../src/components/molecules/image/group';
import CreateMeeting from '../../../src/components/pages/chat-modal/meeting';
